...
import (
	...
	"github.com/HongxuLai/mini-replicaset-controller/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4f3d87e9.example.com",
	...
	if err := (&controller.MiniReplicaReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "MiniReplica")
		os.Exit(1)
	}
